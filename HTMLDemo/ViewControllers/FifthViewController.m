...
@interface FifthViewController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,KSAdaptiveHTMLCellDelegate>
...
- (KSAdaptiveHTMLCell *)cell {
    if (!_cell) {
        ...
        _cell = [[KSAdaptiveHTMLCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellTableIndentifier1];
    }
    return _cell;
}
